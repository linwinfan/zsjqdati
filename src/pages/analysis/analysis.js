...
Page({
  ...
  afterQuestion: function () {
    if (that.data.choseType == 'single' && that.data.nowQuestion.number != that.data.singleQuestionList.length) {
      that.aftersingleQuestion();
    }
    else if (that.data.choseType == 'single' && that.data.nowQuestion.number == that.data.singleQuestionList.length){
      var questionList = that.data.multiQuestionList;
      that.setData({
  ...
  afterMultiQuestion:function(){
    var questionList = that.data.multiQuestionList;
    var afterQuestionNumber = that.data.nowQuestion.number;
    if (afterQuestionNumber == questionList.length)
      return;
